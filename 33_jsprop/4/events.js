...
var clicky = function(e) {
  ...
  // only shows one pop up with the highest priority
  // prediction correct!
};
...
// changes the priority of the listener
...
// if all true, order should be table, trs, tds
// if all false, order should be tds, trs, table
// prediction correct!